<template>
  <dialog id="comment" class="modal">
    <div
      class="modal-box bg-white z-50 drop-shadow-sm flex flex-col pt-4 border-t-2 max-w-full w-2/3"
    >
      ...
      <div
        class="container sticky bg-base-200 p-4 z-[80]"
      ...
      >
        <label class="input input-bordered flex items-center rounded-full">
          ...
          />
          <button
            class="badge badge-info h-4/5 my-[10%] -mr-[12px] rounded-full font-bold text-lg bg-sky-400"
            @click="doComment"
          >
            发布
          </button>
      ...
      <div
        ...
        class="container py-4 h-80 bg-white flex justify-center"
      >
        <h1 class="mt-16 text-2xl">还没有评论哦，快来发一条吧！</h1>
      </div>
