<template>
  <div
    class="menu h-full bg-slate-300 w-1/5 rounded-r-lg flex-nowrap px-6 py-6"
  >
    <TabGroup>
          ...
          <ul>
            <template v-for="tag in tags">
              <li
                ...
                "
              >
                <a @click="emit('jumpTag', tag.chapter, tag.offset)">{{
                  tag.content.length ? tag.content : "无附注"
                }}</a>
              </li>
            </template>
          </ul>
