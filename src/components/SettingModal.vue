<template>
  <dialog id="setting" class="modal">
    <div class="modal-box">
      ...
      <div>
        <span>展示公共标签</span>
        <input type="checkbox" class="toggle toggle-success" v-model="setting.showPublic" />
      </div>
      <div>
        <span>展示私有标签</span>
        <input type="checkbox" class="toggle toggle-success" v-model="setting.showPrivate" />
      </div>
      <div>
        <span>每章为一页</span>
        <input type="checkbox" class="toggle toggle-success" v-model="setting.flipByChapter" />
      </div>
    </div>
